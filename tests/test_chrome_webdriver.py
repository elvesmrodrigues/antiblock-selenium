...
class TestChrome(unittest.TestCase):
    def test_change_ip(self):
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver', options=options, change_ip_after=3)
        driver.renew_ip()
    ...
    def test_minimum_time_fixed_between_calls(self):
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver', time_between_calls=15, random_delay=False)
    ...
    def test_minimum_time_random_between_calls(self):
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver', time_between_calls=15, random_delay=True)
        driver.get('http://icanhazip.com/')
    ...
    def test_save_cookies_when_close(self):
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver', persist_cookies_when_close=True, location_of_cookies=cookie_file)
    ...
    def test_persist_and_load_cookies(self):
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver', persist_cookies_when_close=True)
        ...
        driver = Chrome(executable_path='venv/bin/chromedriver',reload_cookies_when_start=True, cookie_domain='https://www.hackerrank.com/')
        driver.get('https://www.hackerrank.com/login')
